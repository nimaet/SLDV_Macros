...
' -------------------------------------------------------------------------------
	...
	pathName="D:\Mustafa\new beam 05-23-2022\f0_2000Hz\\quadratic\"
	Call OpenExcel
	...
	While strFileName <> ""
		...
		saveNameRe = Replace(strFileName,".svd","_real.xlsx")
		saveNameIm = Replace(strFileName,".svd","_imag.xlsx")
		saveNameCoh = Replace(strFileName,".svd","_coh.xlsx")
