...
' -------------------------------------------------------------------------------
	...
	For Count = 0 To 0
		...
		'strFileName = "D:\Mustafa\new beam 09-15-2021\bragg_bandgap_f_25_khz_v_1-0_new.svd"
	     strFileName = "D:\Nima\Metamaterial beam\dat_Oct\8\amp0--2_kc-8e8.svd"
		...
		Set oDisplayMag = oDomain.Channels("Vib & Ref1").Signals("H1 Velocity / Voltage").Displays("Magnitude")
		...
		For pCount = 1 To ptCount
			...
			ptData = oDataPoint.GetData(oDisplayMag, 0)
